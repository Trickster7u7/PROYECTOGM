    ...
    <div class="content-wrapper pb-4">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <h4>Administrador del Gimnacio</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                            <li class="breadcrumb-item active">Nuevo Administrador del Gimnacio</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <form action="{{ route('gymManager.store') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="row">
                    <div class="col-12">
                        <a href="{{ route('gymManager.list') }}" class="btn btn-secondary">Cancelar</a>
